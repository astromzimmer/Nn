...
<div id="right">
	<div id="file_form" class="view">
		<form name="form1" method="post" action="<?php echo DOMAIN.DS.'admin'.DS.'files'.DS.'update'.DS.$file->attr('id') ?>" enctype="multipart/form-data">
			<div class="header">
			...
			<div class="submit">
				<a href="<?php echo DOMAIN.DS.'admin'.DS.'files'.DS.'view'.DS.$file->attr('id') ?>" class="cancel button">cancel</a>
