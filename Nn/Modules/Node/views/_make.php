<div class="manage">
	<div id="node_form" class="view">
		<form name="form1" method="post" action="<?php echo DOMAIN.'/admin/nodes/create' ?>" data-target="right" enctype="multipart/form-data">
			...
			<div class="submit">
				<a href="<?php echo DOMAIN.'/admin/nodes/view/'.$node->attr('parent_id') ?>" class="cancel button half float" data-target="right" data-ajax><?php echo Nn::babel('Cancel') ?></a>
