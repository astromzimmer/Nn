<div class="node" data-id="<?php echo $node->attr('id') ?>">
	<div class="header maximised">
		<ul>
			...
			<li class="tools">
				<a class="edit" href="<?php echo DOMAIN.DS.'admin'.DS.'nodes'.DS.'edit'.DS.$node->attr('id') ?>" data-tooltip="<?php echo Nn::babel('edit') ?>" data-target="right" data-ajax><?php echo Utils::UIIcon('edit'); ?>
				</a><a class="trash" href="<?php echo DOMAIN.DS.'admin'.DS.'nodes'.DS.'delete'.DS.$node->attr('id') ?>" data-tooltip="<?php echo Nn::babel('trash') ?>" data-target="right" data-ajax><?php echo Utils::UIIcon('trash'); ?>
	...
	<div id="admin_node" class="manage admin_area">
		<?php Nn::partial('Attribute','_list',array('node'=>$node,'dtype'=>$dtype,'atype'=>$atype,'edit_attribute_id'=>$edit_attribute_id)); ?>
	</div>
</div>