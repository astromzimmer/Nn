<div id="left">
	<?php Nn::partial('Style','_list',array('styles'=>$styles)) ?>
</div>
<div id="center">
	<div class="manage">
		<div id="setting_form" class="edit_bg">
			<form name="form1" method="post" action="<?php echo Nn::settings('DOMAIN'),'/admin/styles/create' ?>">
			  <fieldset>
			  ...
			  <fieldset>
			    ...
			    <textarea name="description" class="formfield" id="descriptionField" placeholder="<?php echo Nn::babel('Type some notes regarding this style and its options...') ?>"></textarea>
			  </fieldset>
			  <div class="submit">
